...
#-------------------------------------------------------------------------------------------
                             #INT 15h BIOS break(real mode)---physical memory detection
probe_memory:                          #  real -> protected mode
    movl $0, 0x8000              #struct e820map (nr_map->0x8000)
...
start_probe:
    ...
    7c3d:	4d                   	dec    %ebp
    7c3e:	53                   	push   %ebx
    int $0x15             #function 0x15; ret memory segment information
    7c3f:	cd 15                	int    $0x15
    jnc cont                     #if eflags==0 continue
